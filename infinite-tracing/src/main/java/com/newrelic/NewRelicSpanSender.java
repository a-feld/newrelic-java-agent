...
class NewRelicSpanSender implements Runnable {
    ...
    NewRelicSpanSender(InfiniteTracingConfig config, BlockingQueue<SpanEvent> queue, MetricAggregator aggregator, ChannelManager channelManager) {
    ...
    void pollAndWrite() {
        ...
        V1.Span convertedSpan = NewRelicSpanConverter.convert(span);
